...
const COMPETITIVE_ITEMS = [
  ...
  },
  {
    ...
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/fairy-feather.png"
  },
  {
    id: "booster-energy",
    ...
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/booster-energy.png"
  },
  {
    id: "covert-cloak",
    name: "Capa Furtiva (Covert Cloak)",
    description: "Protege al portador de sufrir efectos secundarios de los movimientos del rival.",
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/covert-cloak.png"
  },
  {
    id: "loaded-dice",
    name: "Dado Trucado (Loaded Dice)",
    description: "Garantiza que los movimientos de ataque múltiple golpeen 4 o 5 veces.",
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/loaded-dice.png"
  },
  {
    id: "punching-glove",
    ...
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/punching-glove.png"
  },
  {
    id: "ability-shield",
    ...
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/ability-shield.png"
  },
  {
    id: "safety-goggles",
  ...
  },
  {
    ...
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/heavy-duty-boots.png"
  },
  {
    id: "rocky-helmet",
  ...
  },
  {
    ...
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/eject-pack.png"
  },
  {
    id: "throat-spray",
    name: "Spray Bucal (Throat Spray)",
    description: "Aumenta el Ataque Especial 1 nivel tras usar un movimiento de sonido. Se consume.",
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/throat-spray.png"
  },
  {
    id: "blastoisinite",
    name: "Blastoisita (Blastoisinite)",
    description: "Permite megaevolucionar a Blastoise en Mega-Blastoise en combate.",
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/blastoisite.png"
  },
  {
    id: "scovillainite",
    name: "Scovillainita (Scovillainite)",
    description: "Permite megaevolucionar a Scovillain en Mega-Scovillain en combate.",
    sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/scovillainite.png"
  },
...
async function loadPresetTeam(teamId) {
  ...
  // Trastienda: Cargar directamente desde el repositorio local AllTeams.txt en vez de peticiones a Pokepaste externo
  showToast("Cargando equipo desde el repositorio local... ⏳", "info");
  const localText = await getLocalTeamPokepasteText(team);
  if (localText) {
    parsed = parseShowdownPaste(localText);
  }
  
  if (!parsed && team.pokepasteText) {
  ...
  if (parsed && parsed.length > 0) {
    ...
    if (importedCount > 0) {
      ...
      updateUI();
      switchTab('builder');
      showToast(`¡Equipo VGC de ${team.creator || "Creador"} cargado desde el repositorio local! 🚀`, "success");
      return;
    }
  }
